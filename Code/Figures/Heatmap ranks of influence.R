...
p1<- ggplot(heatmap_long, aes(x = Predictor, y = Response, fill = Rank)) +
...
#ggsave("Output/Figure_6.jpg", width = 8, height = 6, dpi = 300)

ggsave_elsevier("output/Figure_6.jpeg", plot = p1, width = "one_half_column", height =  90)
