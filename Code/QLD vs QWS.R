...
cor.test(df$QWS, df$QLD) #negatively correlated (-0.11), p < 0.0001


#ggsave('output/QWS QLD Correlations.png', p, height = 8, width  = 10)


## conditional density plotting, comparing average/above average to below average QWS vs. QLD
summary(df$QWS)
